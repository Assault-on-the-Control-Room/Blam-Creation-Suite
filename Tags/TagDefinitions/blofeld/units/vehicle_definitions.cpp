...
namespace blofeld
{
	...
	TAG_BLOCK(human_plane_block, 1)
	{
		...
		{ _field_struct, "steering animation", &steering_animation_struct_struct_definition },
		{ _field_terminator }
	};
	...
	TAG_BLOCK(alien_scout_block, 1)
	{
		...
		{ _field_struct, "engine gravity function", &engine_function_struct_struct_definition },
		{ _field_explanation, "contrail object function", "" },
		{ _field_struct, "contrail gravity function", &engine_function_struct_struct_definition },
	...
	TAG_BLOCK(alien_fighter_block, 1)
	{
		...
		{ _field_explanation, "alien fighter trick variables", "" },
		{ _field_real, "maximum trick frequency" },
		{ _field_real, "loop trick duration" },
		{ _field_real, "roll trick duration" },
		{ _field_explanation, "alien fighter fake flight control", "" },
	...
	TAG_BLOCK(mantis_block, 1)
	{
		...
		{ _field_real, "slide acceleration" },
		{ _field_real, "slide deceleration" },
		{ _field_struct, "walker physics", &walker_physics_struct_struct_definition },
	...
	TAG_BLOCK(vtol_block, 1)
	{
		...
		{ _field_version_less, _engine_type_haloreach, 19 }, // #TODO: vtol block needs research, going the lazy route for now
		{ _field_angle, "research this angle nerd" },
		{ _field_angle, "research this angle nerd" },
		{ _field_angle, "research this angle nerd" },
		{ _field_angle, "research this angle nerd" },
		{ _field_real, "research this float nerd" },
		{ _field_real, "research this float nerd" },
		{ _field_real, "research this float nerd" },
		{ _field_real, "research this float nerd" },
		{ _field_real, "research this float nerd" },
		...
		{ _field_version_greater_or_equal, _engine_type_haloreach, 18 },
		{ _field_struct, "trigger to throttle", &scalar_function_named_struct_struct_definition },
		{ _field_struct, "descent to boost", &vtol_descent_function_struct_struct_definition },
		...
		{ _field_explanation, "interpolation parameters", "these parameters control the interpolation between the two elements in the speed interpolation block" },
		{ _field_real, "interpolation speed domain" },
		{ _field_explanation, "funciton explanation", "acc= INTERPOLATION_ACC(ceiling(throttle, SPEED_TROTTLE_CEILING(speed))), speed+= acc, interpolation= A_B_INTERPOLATION(speed)" },
		{ _field_struct, "SPEED_TROTTLE_CEILING()", &scalar_function_named_struct_struct_definition },
		{ _field_struct, "INTERPOLATION_ACC()", &scalar_function_named_struct_struct_definition },
		{ _field_struct, "A_B_INTERPOLATION() interpolation mapping", &scalar_function_named_struct_struct_definition },
		...
		{ _field_real, "research this nerd" },
		{ _field_real, "research this nerd" },
	...
	TAG_BLOCK(jackal_glider_block, 1)
	{
		...
		{ _field_real, "torque scale#0 defaults to 1" },
		{ _field_explanation, "engine object function", "" },
		{ _field_struct, "engine object function", &engine_function_struct_struct_definition },
		{ _field_explanation, "contrail object function", "" },
		{ _field_struct, "contrail object function", &engine_function_struct_struct_definition },
		{ _field_struct, "steering animation", &steering_animation_struct_struct_definition },
		...
		{ _field_explanation, "wing", "" },
		{ _field_struct, "wing surface", &flight_surface_struct_struct_definition },
		{ _field_explanation, "ailerons", "" },
		{ _field_struct, "aileron surface", &flight_surface_struct_struct_definition },
		{ _field_explanation, "elevator", "" },
		{ _field_struct, "elevator surface", &flight_surface_struct_struct_definition },
		{ _field_explanation, "tail", "" },
		{ _field_struct, "tail surface", &flight_surface_struct_struct_definition },
		{ _field_explanation, "rudder", "" },
		{ _field_struct, "rudder surface", &flight_surface_struct_struct_definition },
		{ _field_explanation, "taxi", "" },
		{ _field_struct, "taxi surface", &flight_surface_struct_struct_definition },
		{ _field_explanation, "ground drag", "" },
		{ _field_struct, "ground drag struct", &jackal_glider_drag_struct_struct_definition },
		{ _field_explanation, "air drag", "" },
		{ _field_struct, "air drag struct", &jackal_glider_drag_struct_struct_definition },
		{ _field_explanation, "takeoff drag", "" },
		{ _field_struct, "takeoff drag struct", &jackal_glider_drag_struct_struct_definition },
		{ _field_terminator }
	};
	...
	TAG_BLOCK(space_fighter_block, 1)
	{
		...
		{ _field_struct, "turn back distance to turn rate", &scalar_function_named_struct_struct_definition },
		{ _field_explanation, "thrust params", "change thrust lag" },
		...
		{ _field_explanation, "dive params", "controls angles under which we change speed during dive" },
		{ _field_real, "minimum dive angle" },
		{ _field_real, "maximum dive angle" },
		{ _field_explanation, "strafe params", "scale speed params while strafing" },
		{ _field_real, "strafe boost power" },
		{ _field_explanation, "wingtip params", "wingtip" },
	...
	TAG_STRUCT(vehicle_group)
	{
		...
		{ _field_struct, "physics types", &vehicle_physics_types_struct_struct_definition },
		{ _field_explanation, "friction and antigravity points", "" },
		{ _field_struct, "havok vehicle physics", &havok_vehicle_physics_struct_struct_definition },

		{ _field_version_less, _engine_type_haloreach },
		{ _field_block, "havok phantom shapes", &phantom_shapes_block_block }, // #TODO: replace with actual havok block
	...
	TAG_STRUCT(vehicle_physics_types_struct)
	{
		...
		{ _field_version_less, _engine_type_haloreach, 3 }, // Could be another type, just shoving unknowns here for now
		{ _field_long_integer, "unknown@" },
		{ _field_long_integer, "unknown@" },
		{ _field_long_integer, "unknown@" },
	...
	TAG_STRUCT(human_tank_struct)
	{
		...
		{ _field_explanation, "reverse differential", "how quickly the differential reaches it\'s target and what the ratio is" },
	...
	TAG_STRUCT(flight_surface_struct)
	{
		...
		{ _field_explanation, "normal force", "force= k*CEILING(SQR(q*velocity), function_ceiling)" },
		{ _field_real, "q" },
		{ _field_real, "k" },
