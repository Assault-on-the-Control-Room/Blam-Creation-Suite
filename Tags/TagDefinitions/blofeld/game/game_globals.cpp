...
namespace blofeld
{
	...
	TAG_STRUCT(globals_struct_definition)
	{
		...
		{ _field_block, "damage{falling damage}", &damage_globals_block_block },
		...
		{ _field_struct, "language pack3!", &language_pack_definition_struct_definition },
		{ _field_struct, "language pack4!", &language_pack_definition_struct_definition },
		{ _field_struct, "language pack5!", &language_pack_definition_struct_definition },
		{ _field_struct, "language pack6!", &language_pack_definition_struct_definition },
		{ _field_struct, "language pack7!", &language_pack_definition_struct_definition },
		{ _field_struct, "language pack8!", &language_pack_definition_struct_definition },
		{ _field_struct, "language pack9!", &language_pack_definition_struct_definition },
